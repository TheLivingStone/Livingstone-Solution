...
<p className="mil-light-soft">A47 - 402, Bole City<br/> East Mindspace,<br/>
Addis Ababa.<span className="mil-no-wrap"><br/>+1 424 216 6070</span></p>
                        ...
                        <div className="col-lg-6 mil-mb-60">
                                ...
                                <p className="mil-light-soft">Living Stone Solution Pvt Ltd, 
                                Near Bole Road, 
                                Addis Ababa, Ethiopia.<span className="mil-no-wrap"><br/>+251 9390132330</span></p>
