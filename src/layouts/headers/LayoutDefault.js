...
const DefaultHeader = ({ extraClass }) => {
    ...
    // Set true if header background is black, false otherwise
    ...
    const clickedMobileMenuItemParent = (e) => {
        ...
        lists.forEach((list) => list.classList.remove('mil-active'));

        const links = document.querySelectorAll('.mil-has-children a');
        links.forEach((link) => link.classList.remove('mil-active'));
                                        ...
                                        <div className="row">
                                            ...
                                            <div className="col-lg-4 mil-mb-60">
                                                ...
                                                <ul className="mil-menu-list">
                                                    ...
                                                    <li><Link href="/terms-and-conditions" className="mil-light-soft">Terms and conditions</Link></li>
