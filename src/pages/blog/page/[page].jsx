...
const Blog = ({ posts, currentPage, totalPosts, categories }) => {
  ...
  return (
    <Layouts>
      <SEO title={`Blog - Page ${currentPage}`} description={`Tech Blog & Insights Page ${currentPage} - Learn more about Web Development, AI, and Software Engineering.`} canonical={`https://solution.thelivingstonefoundation.com/blog/page/${currentPage}`} />
